...
export default function Hero({ fullName, title, valueProposition, heroImage }: HeroProps) {
  ...
  const handleProfileMouseMove = (event: React.MouseEvent<HTMLDivElement>) => {
    ...
    cardX.set(relX);
    cardY.set(relY);
    animate(shineOpacity, 1, { duration: 0.25 });
  };
  ...
  const handleProfileMouseLeave = () => {
    ...
    animate(shineOpacity, 0, { duration: 0.35 });
  };
  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto px-6 max-w-5xl relative z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full glass-card text-xs font-semibold text-primary-custom border border-primary-custom/10 mb-6 shadow-sm"
          >
          ...
          <motion.h1
            variants={itemVariants}
            className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-6 bg-clip-text text-transparent bg-gradient-to-r from-foreground-custom via-foreground-custom to-primary-custom leading-tight"
          >
          ...
          <motion.p
            variants={itemVariants}
            className="text-lg sm:text-xl md:text-2xl font-semibold text-muted-foreground-custom mb-4 font-heading"
          >
            {title}
          </motion.p>
          ...
          <motion.p
            variants={itemVariants}
            className="text-sm sm:text-base md:text-lg text-muted-foreground-custom/80 mb-8 max-w-xl leading-relaxed"
          >
            {valueProposition}
          </motion.p>
          ...
          <motion.div
            variants={itemVariants}
            className="flex flex-col sm:flex-row items-center gap-6 mt-2 w-full justify-center md:justify-start"
          >
            {/* CTA Buttons */}
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              <InteractiveButton
                ...
                variant="primary"
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl bg-gradient-to-r from-primary-custom to-secondary-custom text-primary-foreground font-bold text-xs shadow-md hover:shadow-lg transition-all duration-200 text-center cursor-pointer uppercase tracking-wider group"
              >
                Explore Projects
              ...
              <InteractiveButton
                ...
                variant="secondary"
                className="w-full sm:w-auto px-6 py-3.5 rounded-xl glass-card text-foreground-custom font-bold text-xs border border-border/25 hover:bg-primary-custom/10 hover:text-primary-custom transition-all duration-200 text-center cursor-pointer uppercase tracking-wider"
              >
                Get In Touch
        ...
        <div className="md:col-span-5 flex justify-center order-1 md:order-2">
          <motion.div
            className="relative w-56 h-56 sm:w-64 sm:h-64 md:w-72 md:h-72 lg:w-80 lg:h-80 flex items-center justify-center cursor-pointer"
          ...
          >
            ...
            <div
              className="relative w-full h-full rounded-[38px] p-4 glass-card border border-white/20 bg-white/5 backdrop-blur-xl shadow-2xl flex items-center justify-center overflow-hidden"
              style={{ transformStyle: 'preserve-3d', transform: 'translateZ(10px)' }}
            >
              {/* Inner picture casing container (translated slightly in Z for depth) */}
              <div 
                className="w-full h-full rounded-[28px] overflow-hidden bg-muted-custom/10 relative border border-white/10"
